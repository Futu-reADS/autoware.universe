// Generated by dzn code from /home/avinash/autoware.SMV/src/universe/autoware.universe/planning/surround_obstacle_checker/src/surround_obstacle_checker_dezyne.dzn
...
surroundObstacleChecker::setStoppingState_stoppingState ()
{
  if (setStoppingState.state == ::IStoppingState::State::PASS)
    {
      if (this->status.in.getVehicleStoppingStatus ())
        {
          if (this->status.in.getObstacleStatusDuringPass ())
            ...
            {
              if (this->getStoppingState.in.stoppingState () != ::IStoppingState::State::STOP)
                {
                  *this->dzn_reply_IStoppingState_State = this->getStoppingState.in.stoppingState ();
                  if ((*this->dzn_out_setStoppingState)) (*this->dzn_out_setStoppingState) ();
                  (*this->dzn_out_setStoppingState) = nullptr;
                }
              else
